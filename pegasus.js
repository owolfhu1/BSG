...
/*
    pegasus expansion includes :
        - 20 new crisis cards: CrisisMap
        - 5 new super crisis cards: SuperCrisisMap
        - 5 new destination cards: DestinationMap
        - 2 new loyalty cards: LoyaltyMap
        - 6 agenda cards: AgendaMap
        - 7 new characters (3 cylon leaders): CharacterMap
        - 34 new skill cards: SkillCardMap
        - 30 New Caprica Crisis cards: CapricaCrisisMap
        - 9 new Quorum cards: QuorumMap
...
exports.data = Object.freeze({
    ...
    CapricaCrisisMap : CapricaCrisisMap,
    QuorumMap : QuorumMap,
